...
<body background="EMOS1.jpg">
	...
	<header>
	<strong>
		Welcome	<%=empDetail.getEmp_First_Name()%>
	</strong>
	</header>
	<table style="width: 10%" align="left">
		...
		<tr>
			...
			<td bgcolor="#0099FF"><%=empDetail.getEmp_First_Name()%></td>
			<td bgcolor="#0099FF"><%=empDetail.getEmp_Last_Name()%></td>
		</tr>
		<tr>
...
"><%=empDetail.getMgrId()%></td>
	...
	<a class="search-btn" href="#"> -->
		...
		<input type="submit" value="LeaveManagementSystem">
			...
			<form action="ManagerApprovalScreen.jsp" >
